...
<head>
  ...
  <title>AvaLive 4K 60FPS Ultra-HD Live Streamer v4.5.7</title>
  <style>
...
<body>
  <div id="stage">
    ...
    <div id="badge">🔴 4K 60 FPS REALTIME v4.5.7</div>
  </div>
  <script>
    (function() {
        ...
        if (typeof io !== 'undefined') {
          try {
            ...
            socket.on('connect', function() {
              if (badge) badge.innerText = '🟢 4K 60 FPS REALTIME v4.5.7';
