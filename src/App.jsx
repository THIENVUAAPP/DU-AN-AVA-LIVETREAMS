        ...
        <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4">
          <div className="glass-panel p-6 sm:p-8 rounded-[36px] border border-white/20 max-w-md w-full text-center space-y-5 shadow-2xl bg-[#0D0D15]/98 animate-fadeIn max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="w-14 h-14 rounded-2xl overflow-hidden border-2 border-cyan-400/60 shadow-[0_0_20px_rgba(6,182,212,0.4)] bg-black flex items-center justify-center p-0.5">
              ...
              <div className="w-14 h-14 rounded-2xl bg-white flex items-center justify-center p-2.5 shadow-glow-white border-2 border-white/40">
