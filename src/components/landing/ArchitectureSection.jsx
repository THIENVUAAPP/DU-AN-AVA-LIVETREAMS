...
export default function ArchitectureSection() {
  const layers = [
    { num: '06', emoji: '📊', title: 'DATA & ANALYTICS LAYER', desc: 'Realtime Analytics / Log Tracking / Báo cáo doanh số & Chuyển đổi / Giám sát KPI', color: 'from-[#EC4899] to-[#F43F5E]', border: 'border-[#EC4899]/50 hover:border-[#EC4899]', glow: 'shadow-[0_0_30px_rgba(236,72,153,0.3)]', badge: 'bg-[#EC4899]/20 text-[#EC4899]' },
    { num: '05', emoji: '🛒', title: 'COMMERCE ENGINE LAYER', desc: 'Quản lý kho sản phẩm / Flash Sale / Tạo mã giảm giá động / Auto Checkout', color: 'from-[#3B82F6] to-[#00F0FF]', border: 'border-[#3B82F6]/50 hover:border-[#00F0FF]', glow: 'shadow-[0_0_30px_rgba(59,130,246,0.3)]', badge: 'bg-[#3B82F6]/20 text-[#00F0FF]' },
    { num: '04', emoji: '🎬', title: 'EXPERIENCE & MEDIA LAYER', desc: 'Voice Synthesis / Biểu cảm 3D / Xử lý video thời gian thực / Nhạc nền AI', color: 'from-[#10B981] to-[#00F0FF]', border: 'border-[#10B981]/50 hover:border-[#10B981]', glow: 'shadow-[0_0_30px_rgba(16,185,129,0.3)]', badge: 'bg-[#10B981]/20 text-[#10B981]' },
    { num: '03', emoji: '⚡', title: 'EVENT DISPATCHER ENGINE', desc: 'Bắt trọn Comment / Quà tặng / Thả tim / Follow / Kích hoạt phản hồi tức thì', color: 'from-[#F59E0B] to-[#EF4444]', border: 'border-[#F59E0B]/50 hover:border-[#F59E0B]', glow: 'shadow-[0_0_30px_rgba(245,158,11,0.3)]', badge: 'bg-[#F59E0B]/20 text-[#F59E0B]' },
    { num: '02', emoji: '🧠', title: 'INTELLIGENCE & AI BRAIN LAYER', desc: 'Bộ não phân tích ngữ cảnh / Kiến thức thương hiệu / Thuật toán chốt đơn thông minh', color: 'from-[#00F0FF] to-[#A855F7]', border: 'border-[#00F0FF]/50 hover:border-[#00F0FF]', glow: 'shadow-[0_0_30px_rgba(0,240,255,0.3)]', badge: 'bg-[#00F0FF]/20 text-[#00F0FF]' },
    { num: '01', emoji: '👸', title: 'IDENTITY & PROFILE LAYER', desc: 'AI Idol đại diện / Nhận diện thương hiệu / Tone giọng độc quyền / Phong cách cá nhân hóa', color: 'from-[#9333EA] to-[#EC4899]', border: 'border-[#9333EA]/50 hover:border-[#EC4899]', glow: 'shadow-[0_0_30px_rgba(147,51,234,0.3)]', badge: 'bg-[#9333EA]/20 text-[#EC4899]' }
  ];
        ...
        <RevealOnScroll>
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[#00F0FF]/50 bg-[#00F0FF]/10 backdrop-blur-xl shadow-[0_0_20px_rgba(0,240,255,0.3)] mb-6">
            ...
            <span className="text-xs font-black text-transparent bg-clip-text bg-gradient-to-r from-[#00F0FF] via-white to-[#EC4899] uppercase tracking-[0.2em]">
              KIẾN TRÚC HỆ ĐIỀU HÀNH AVA LIVE OS
            </span>
          </div>
          ...
          <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tight mb-4 leading-tight drop-shadow-[0_4px_25px_rgba(0,0,0,0.8)]">
            HỆ THỐNG 6 TẦNG CÔNG NGHỆ <br className="hidden md:block"/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00F0FF] via-[#EC4899] to-[#9333EA]">
              VẬN HÀNH ĐỘC QUYỀN TỶ ĐÔ
            </span>
          </h2>
          <p className="text-gray-300 text-base md:text-lg max-w-2xl mx-auto font-light mb-16">
            Được kiến trúc theo tiêu chuẩn Enterprise, đảm bảo tính ổn định, tốc độ phản hồi tính bằng mili-giây và khả năng mở rộng không giới hạn.
          </p>
        </RevealOnScroll>
              ...
              <RevealOnScroll key={index}>
                <div className={`relative bg-gradient-to-r from-[#1A103A]/95 via-[#120B29]/95 to-[#0B071B]/98 backdrop-blur-2xl border-2 ${layer.border} rounded-[28px] p-6 md:p-8 flex flex-col md:flex-row items-center gap-7 transition-all duration-500 z-10 mx-auto max-w-3xl group cursor-default ${layer.glow} hover:-translate-y-1.5`}>
                  ...
                  <div className={`w-20 h-20 shrink-0 rounded-2xl bg-gradient-to-br ${layer.color} border-2 border-white/50 flex flex-col items-center justify-center shadow-[0_0_25px_rgba(0,0,0,0.6)] group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 relative`}>
                    ...
                    <span className="text-[10px] font-black text-white uppercase tracking-wider font-mono">TẦNG {layer.num}</span>
                  </div>
