            ...
            {streamSourceMode === "url" && (
              <div className="p-4 mt-4 rounded-2xl bg-amber-950/30 border border-amber-500/40 space-y-3 text-xs animate-fadeIn">
                ...
                <div className="flex flex-wrap items-center gap-1.5 pt-1">
                  ...
                  {[
                    { label: '💃 Sàn Nhảy 3D (Đã hợp nhất 1 Link)', url: `${typeof window !== 'undefined' ? window.location.origin.replace('localhost', '127.0.0.1.nip.io').replace('127.0.0.1', '127.0.0.1.nip.io') : ''}/?overlay=live` },
                    { label: '🌐 Sân Khấu Live Sạch (Khuyên dùng)', url: `${typeof window !== 'undefined' ? window.location.origin.replace('localhost', '127.0.0.1.nip.io').replace('127.0.0.1', '127.0.0.1.nip.io') : ''}/?overlay=live` },
                    { label: '⚔️ Đấu Trường PK (Đã hợp nhất 1 Link)', url: `${typeof window !== 'undefined' ? window.location.origin.replace('localhost', '127.0.0.1.nip.io').replace('127.0.0.1', '127.0.0.1.nip.io') : ''}/?overlay=live` },
                    { label: '🗺️ Bản Đồ Live (Đã hợp nhất 1 Link)', url: `${typeof window !== 'undefined' ? window.location.origin.replace('localhost', '127.0.0.1.nip.io').replace('127.0.0.1', '127.0.0.1.nip.io') : ''}/?overlay=live` },
