...
export const UPDATE_NOTES = [
  {
    title: '🚀 Bản Cập Nhật v4.9.38 - Chuẩn Hóa Link TikTok Live Studio Online HTTPS (Chống Chặn Localhost), Nút Đồng Bộ Sân Khấu Mặc Định Tắt, Triệt Tiêu Video Tự Hồi Sinh & Kích Hoạt 100% Nút Bấm Thanh Dock',
    description: '1. Nút LINK TIKTOK Chuẩn Hóa 100% Online HTTPS (Chống Chặn Localhost/Website): Khắc phục triệt để lỗi TikTok Live Studio chặn localhost/127.0.0.1 và website Vercel; nút LINK TIKTOK tại Luồng Live Idol Avatar tự động phân giải và sao chép chuẩn xác đường link Cloudflare Tunnel HTTPS (https://...trycloudflare.com/live-stream) đảm bảo luồng phát 60 FPS mượt mà tức thì 0ms. 2. Nút ĐỒNG BỘ RA SÂN KHẤU CHÍNH Mặc Định Tắt (Màu Đỏ): Trạng thái mặc định luôn là tắt (🔴 📡 ĐỒNG BỘ RA SÂN KHẤU CHÍNH), tuyệt đối không tự ý phát ra Sân Khấu Chính khi chưa có lệnh; chỉ khi người dùng chủ động bấm click mới kích hoạt chuyển sang màu xanh và phát ra Sân Khấu Chính. 3. Xóa Video Là Xóa Triệt Để 100% Không Tự Hồi Sinh: Gỡ bỏ hoàn toàn logic tự ý gán lại video từ uploads trong backend; khi người dùng xóa video bước/nhân vật, video lập tức biến mất hoàn toàn khỏi Sân Khấu Chính và Window Capture, triệt tiêu 100% hiện tượng video cũ tự động phát lại. 4. Kích Hoạt 100% Toàn Bộ Nút Bấm Thanh Dock Window Capture (Ảnh 2): Toàn bộ các nút [• LIVE], [⏸️ Dừng], [🔊 Bật Tiếng], [📐 Tràn], và [✕ Ẩn (H)] cùng nút mắt phục hồi phản hồi tức thì 100%, thao tác cực nhạy, điều khiển dừng/phát và âm thanh chuẩn xác 2 chiều. 5. Tinh Gọn Modal Cập Nhật Duy Nhất Bản Mới Nhất: Loại bỏ toàn bộ danh sách phiên bản cũ trong modal thông báo, chỉ hiển thị duy nhất thông tin của bản cập nhật mới nhất. 6. Khóa Chặt 100% Tất Cả Các Module Hệ Thống: Bảo toàn nguyên vẹn 100% trạng thái hoạt động của mọi tab chức năng.'
  }
];
