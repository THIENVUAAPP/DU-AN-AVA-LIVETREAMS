...
export const UPDATE_NOTES = [
  {
    title: '🚀 Bản Cập Nhật v4.9.37 - Khôi Phục Luồng Video, Hình Ảnh, Tiêu Đề Từ Live Idol Avatar Lên Sân Khấu Chính, Window Capture OBS & Link TikTok Live Studio; Sửa Triệt Để Các Nút Bấm Thanh Dock (Ảnh 1)',
    description: '1. Khôi Phục Luồng Video, Hình Ảnh, Tiêu Đề Lên Sân Khấu Chính 9:16: Toàn bộ video nhân vật, video phụ PiP, banner hình ảnh và tiêu đề chữ từ Live Idol Avatar (Idol 1-4, Kho Live, Sequencer kịch bản) tự động hiển thị tức thì, sắc nét trên Sân Khấu Chính mà không bị chặn bởi bất kỳ điều kiện ẩn nào. 2. Đồng Bộ Tuyệt Đối Sang Window Capture OBS & Đường Link Online TikTok Live Studio: Mọi nội dung phát từ Live Idol Avatar được đồng bộ liên tục 0ms sang cả Window Capture (/window-capture) và link phát TikTok Live Studio (/live-stream); bổ sung lớp hiển thị banner hình ảnh và tiêu đề chữ sắc nét trên cả 2 giao diện. 3. Sửa Triệt Để Các Nút Bấm Thanh Dock (Ảnh 1): Loại bỏ hoàn toàn xung đột đa sự kiện (click, pointerdown, touchstart và inline onclick) gây lỗi tự lật trạng thái; trang bị bộ lọc throttle debounce 250ms giúp các nút Tạm dừng/Phát (Space), Bật/Tắt Tiếng (M), Tràn/Vừa Khung Hình và Ẩn (H) bấm ăn 100% cực kỳ nhạy và mượt mà. 4. Khắc Phục Triệt Để Đường Link TikTok Live Studio (/live-stream): Tự động phân giải video từ Avatar 1 hoặc file video tải lên gần nhất trong uploads/, triệt tiêu 100% tình trạng treo spinner "Đang kết nối luồng live..." hay đen màn hình. 5. Khóa Chặt 100% Tất Cả Các Module Hệ Thống: Bảo toàn nguyên vẹn 100% trạng thái hoạt động của mọi tab chức năng.'
  },
  {
