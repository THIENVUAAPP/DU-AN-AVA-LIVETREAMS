            ...
            <div className="space-y-4">
              ...
              <div className="p-5 rounded-2xl bg-gradient-to-br from-[#121528] via-[#0f111f] to-[#181a32] border border-cyan-500/40 text-center space-y-4 shadow-xl relative overflow-hidden">
                ...
                <div className="flex items-center justify-center">
                  <div className="w-16 h-16 rounded-3xl overflow-hidden border-2 border-cyan-400/60 shadow-[0_0_25px_rgba(6,182,212,0.4)] bg-black flex items-center justify-center p-1">
                ...
                >
                  ...
                  <span>{isLoggingIn ? '⏳ Đang Kết Nối Google...' : 'KẾT NỐI TRỰC TIẾP VỚI GOOGLE'}</span>
                </button>
              </div>
