...
export const SUBSCRIPTION_PACKAGES = [
  {
    id: 'sub_starter',
    name: 'Gói Starter Khởi Nghiệp',
    type: 'subscription',
    priceMonthly: 499000,
    priceAnnual: 4990000,
    hours: '200 Giờ Live / tháng',
    multistream: '3 Kênh Multistream',
    res: 'Full HD 1080p 60fps',
    tokensIncluded: 12000,
    desc: 'Dành cho cá nhân & shop khởi nghiệp bán hàng chuyên nghiệp',
    features: [
      'Thời lượng: 200 Giờ Live / tháng (~4-5 phiên live chuyên sâu)',
      '3 Kênh Multistream cùng lúc (TikTok, Shopee, Facebook)',
      'Độ phân giải Full HD 1080p 60fps sắc nét',
      'Cấp 12.000 Token AI ElevenLabs mỗi tháng',
      'Đồng bộ 3 kênh giọng: Idol, Quản lý & BLV Game PK',
      'Kho kịch bản 1-chạm & tương tác phòng live tự động'
    ],
    badge: 'KHỞI NGHIỆP',
    color: 'blue'
  },
  {
    id: 'sub_business',
    name: 'Gói Pro Growth (Tăng Trưởng)',
    type: 'subscription',
    priceMonthly: 1390000,
    priceAnnual: 13900000,
    hours: 'Không Giới Hạn Giờ Live',
    multistream: '5 Kênh Multistream',
    res: '2K / 4K Ultra HD 60fps',
    tokensIncluded: 40000,
    popular: true,
    desc: 'Bán chạy nhất cho Shop tăng trưởng, Doanh nghiệp & Chuỗi bán lẻ',
    features: [
      'Thời lượng: Không giới hạn giờ live / tháng',
      '5 Luồng Livestream đa nền tảng cùng lúc',
      'Độ phân giải 2K / 4K 60fps siêu mượt',
      'Cấp 40.000 Token AI ElevenLabs (Tặng thưởng +15%)',
      'Auto-Trigger chốt đơn flash sale tự động',
      'Hỗ trợ 5 Idol AI & Tùy biến giọng đọc chuyên sâu',
      'Ưu tiên băng thông đường truyền giọng nói AI'
    ],
    badge: 'BÁN CHẠY NHẤT',
    color: 'indigo'
  ...
  {
    id: 'sub_enterprise',
    name: 'Gói Enterprise VIP Master',
    type: 'subscription',
    priceMonthly: 3500000,
    priceAnnual: 35000000,
    hours: 'UNLIMITED KHÔNG GIỚI HẠN',
    multistream: '30+ Kênh Multistream',
    res: '4K Dedicated 10Gbps',
    tokensIncluded: 120000,
    desc: 'Giải pháp tối thượng cho Studio, MCN & Tập đoàn bán hàng',
    features: [
      'Thời lượng: Không giới hạn giờ live & không giới hạn Idol',
      '30+ Luồng Stream đồng thời không giới hạn',
      'Hạ tầng máy chủ riêng Dedicated 10Gbps',
      'Cấp 120.000 Token AI ElevenLabs (Tặng thưởng +25%)',
      'Độc quyền: Tạo Idol AI bằng 1 ảnh miễn phí',
      'Kỹ thuật viên VIP hỗ trợ 1-1 riêng biệt 24/7'
    ],
