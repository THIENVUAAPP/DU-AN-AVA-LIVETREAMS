...
export default function EnterprisePayment({ setActiveTab, initialCategory = "subscription" }) {
  ...
  const subscriptionPlans = [
    { 
      ...
      priceVnd: billingCycle === "annual" ? "4.990.000" : "499.000", 
      priceDisplay: billingCycle === "annual" ? "4.990.000đ" : "499.000đ", 
      priceNum: billingCycle === "annual" ? 4990000 : 499000,
      period: billingCycle === "annual" ? "/ năm (Tặng 2 tháng)" : "/ tháng",
      orderCode: "ASPMRZ1AC12HVQ4",
      hours: "⚡ 200 Giờ Live / tháng",
      channels: "3 Kênh Multistream (TikTok, Shopee, FB)",
      res: "Full HD 1080p 60fps",
      tokens: "12.000 Token AI / tháng",
      badge: "KHỞI NGHIỆP BÁN HÀNG"
    },
    { 
      id: "business", 
      name: "Pro Growth (Tăng Trưởng)", 
      priceVnd: billingCycle === "annual" ? "13.900.000" : "1.390.000", 
      priceDisplay: billingCycle === "annual" ? "13.900.000đ" : "1.390.000đ", 
      priceNum: billingCycle === "annual" ? 13900000 : 1390000,
      period: billingCycle === "annual" ? "/ năm (Tặng 2 tháng)" : "/ tháng",
      orderCode: "ASPMRZ1AC12HVQ4",
      popular: true,
      hours: "⚡ UNLIMITED Giờ Live / tháng",
      channels: "5 Kênh Multistream cùng lúc",
      res: "2K / 4K 60fps Ultra HD",
      tokens: "40.000 Token AI / tháng (+15%)",
      badge: "BÁN CHẠY NHẤT"
    },
    { 
      id: "enterprise", 
      name: "Enterprise VIP Master", 
      priceVnd: billingCycle === "annual" ? "35.000.000" : "3.500.000", 
      priceDisplay: billingCycle === "annual" ? "35.000.000đ" : "3.500.000đ", 
      priceNum: billingCycle === "annual" ? 35000000 : 3500000,
      period: billingCycle === "annual" ? "/ năm (Tặng 2 tháng)" : "/ tháng",
      orderCode: "ASPMRZ1AC12HVQ4",
      hours: "⚡ UNLIMITED Không Giới Hạn Giờ Live",
      channels: "30+ Luồng Stream Không Giới Hạn",
      res: "4K Dedicated 10Gbps Server",
      tokens: "120.000 Token AI / tháng (+25%)",
