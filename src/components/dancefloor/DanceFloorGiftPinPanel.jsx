...
export default function DanceFloorGiftPinPanel({ rules, giftTiers, characters }) {
  ...
  if (!pinned) {
    return (
      <button
        ...
        className="absolute bottom-3 left-3 z-30 p-2 rounded-full bg-black/70 border border-white/20 text-white cursor-pointer"
  ...
  return (
    <div className="absolute bottom-3 left-3 z-30 w-64 rounded-2xl bg-black/75 backdrop-blur border border-white/20 overflow-hidden">
