...
export const MASTER_DNA_FEMALE_VIETNAMESE_40_VOICES = [
  // --- 20 GIỌNG NỮ BÁN HÀNG — 50% CORE SALES ---
  {
    ...
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Neutral', accent_strength: 55 },
      persona: { age: '24-30', personality: 'vui, gần gũi, dễ tạo thiện cảm', authority: 70, friendliness: 96 },
      style: { primary: 'livestream_sales', secondary: ['consulting', 'soft_cta', 'natural_closing'] },
      emotion: { warmth: 92, happiness: 88, excitement: 82, confidence: 86, urgency: 55, empathy: 87 },
      acoustic: { pitch: 72, depth: 34, warmth: 91, resonance: 55, breathiness: 18, clarity: 94, articulation: 93, speed: 82, rhythm: 86, intonation: 91, energy: 87, emphasis: 88, pause: 42 }
    },
    dspProfile: { lowGain: -0.5, midFreq: 1300, midGain: 2.8, presenceFreq: 4200, presenceGain: 5.2, highGain: 3.5, reverb: 0.05, reverbDecay: 0.32, compressor: { threshold: -20, ratio: 3.8, attack: 0.005, release: 0.15 } }
  },
  {
    ...
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH', accent: 'Northern Standard', accent_strength: 65 },
      persona: { age: '28-38', personality: 'thanh lịch, có kiến thức, đáng tin', authority: 88, friendliness: 78 },
      style: { primary: 'expert_sales', secondary: ['luxury_live', 'logical_sales'] },
      emotion: { warmth: 78, happiness: 64, excitement: 68, confidence: 93, urgency: 40, empathy: 76 },
      acoustic: { pitch: 58, depth: 52, warmth: 76, resonance: 70, breathiness: 10, clarity: 97, articulation: 98, speed: 72, rhythm: 74, intonation: 79, energy: 74, emphasis: 87, pause: 62 }
    },
    dspProfile: { lowGain: 2.0, midFreq: 1050, midGain: 2.5, presenceFreq: 3500, presenceGain: 4.5, highGain: 2.2, reverb: 0.05, reverbDecay: 0.30, compressor: { threshold: -18, ratio: 3.5, attack: 0.008, release: 0.18 } }
  },
  {
    ...
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Neutral', accent_strength: 48 },
      persona: { age: '22-28', personality: 'hoạt bát, hướng ngoại', authority: 70, friendliness: 92 },
      style: { primary: 'TikTok Live', secondary: ['flash_sale', 'comment_interaction', 'strong_cta'] },
      emotion: { warmth: 82, happiness: 94, excitement: 97, confidence: 90, urgency: 82, empathy: 72 },
      acoustic: { pitch: 78, depth: 27, warmth: 82, resonance: 48, breathiness: 16, clarity: 91, articulation: 89, speed: 94, rhythm: 95, intonation: 96, energy: 98, emphasis: 97, pause: 28 }
    },
    dspProfile: { lowGain: -1.2, midFreq: 1450, midGain: 3.2, presenceFreq: 4500, presenceGain: 5.8, highGain: 4.2, reverb: 0.04, reverbDecay: 0.25, compressor: { threshold: -22, ratio: 4.5, attack: 0.003, release: 0.12 } }
  },
  {
    ...
    rate: 1.08,
    recommendedFor: 'both',
    desc: 'Giọng nữ Bắc lanh lợi, hoạt ngôn lưu loát, đối đáp bình luận thông minh, dẫn dắt phiên live cực kỳ mượt mà.',
    sampleText: 'Bác nào đang ngắm mã này thì chốt luôn đi nhé, chất vải đanh mịn mặc mát rượi, em bao đổi trả tận nhà nếu không ưng ý luôn ạ!',
    edgePitch: '+6%',
    edgeRate: '+8%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH', accent: 'Northern Conversational', accent_strength: 68 },
      persona: { age: '23-32', personality: 'lanh lợi, hoạt ngôn', authority: 74, friendliness: 90 },
      style: { primary: 'livestream', secondary: ['sales', 'reply_comments', 'crowd_engaging'] },
      emotion: { warmth: 79, happiness: 91, excitement: 90, confidence: 89, urgency: 70, empathy: 73 },
      acoustic: { pitch: 73, depth: 35, warmth: 79, resonance: 53, breathiness: 12, clarity: 96, articulation: 95, speed: 91, rhythm: 92, intonation: 94, energy: 94, emphasis: 93, pause: 32 }
    },
    dspProfile: { lowGain: -0.2, midFreq: 1380, midGain: 2.8, presenceFreq: 4100, presenceGain: 5.0, highGain: 3.5, reverb: 0.04, reverbDecay: 0.28, compressor: { threshold: -20, ratio: 4.0, attack: 0.005, release: 0.15 } }
  },
  {
    id: 'vn_f_sales_meko_sweet_05',
    name: '[NEW] 05. Nữ Miền Tây Ngọt Ngào 👑 (VN-F-SALES-MEKO-SWEET)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.02,
    recommendedFor: 'both',
    desc: 'Giọng nữ miền Tây chân tình, mộc mạc, ngọt lịm như mía lùi, chuyên các mặt hàng gia đình, nông sản và ẩm thực.',
    sampleText: 'Dạ em gái miền Tây chào cô chú anh chị mình nha! Hàng quê em mới lên thơm ngon đậm đà, mọi người ủng hộ em một đơn lấy thảo nè!',
    edgePitch: '+4%',
    edgeRate: '+2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'MEKONG', accent: 'Mekong Southern', accent_strength: 72 },
      persona: { age: '25-35', personality: 'chân thành, dễ mến', authority: 68, friendliness: 98 },
      style: { primary: 'warm_sales', secondary: ['livestream', 'family_lifestyle'] },
      emotion: { warmth: 96, happiness: 84, excitement: 70, confidence: 81, urgency: 42, empathy: 92 },
      acoustic: { pitch: 69, depth: 38, warmth: 96, resonance: 52, breathiness: 20, clarity: 88, articulation: 87, speed: 73, rhythm: 78, intonation: 89, energy: 78, emphasis: 80, pause: 52 }
    },
    dspProfile: { lowGain: 0.8, midFreq: 1200, midGain: 3.0, presenceFreq: 3800, presenceGain: 4.6, highGain: 3.0, reverb: 0.06, reverbDecay: 0.35, compressor: { threshold: -18, ratio: 3.2, attack: 0.008, release: 0.20 } }
  },
  {
    id: 'vn_f_sales_closer_06',
    name: '[NEW] 06. Nữ Chuyên Chốt Sale Core Closer 👑 (VN-F-SALES-CLOSER)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.05,
    recommendedFor: 'both',
    desc: 'Giọng nữ sát thủ chốt đơn, quyết đoán, tự tin, nhấn nhá giá và lợi ích dứt khoát, xử lý do dự khách hàng đỉnh cao.',
    sampleText: 'Ưu đãi giảm 50% chỉ áp dụng ngay trong phiên live này! Anh chị bấm vào giỏ hàng, chọn số lượng và nhấn Mua Ngay để giữ giá tốt nhất!',
    edgePitch: '+0%',
    edgeRate: '+5%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'VIETNAMESE_NEUTRAL', accent: 'Standard Closer', accent_strength: 35 },
      persona: { age: '27-38', personality: 'quyết đoán, tự tin', authority: 94, friendliness: 82 },
      style: { primary: 'sales_closing', secondary: ['livestream', 'cta', 'handling_hesitation', 'closing'] },
      emotion: { warmth: 80, happiness: 72, excitement: 84, confidence: 98, urgency: 88, empathy: 76, intensity: 95 },
      acoustic: { pitch: 62, depth: 48, warmth: 80, resonance: 67, breathiness: 8, clarity: 97, articulation: 96, speed: 84, rhythm: 88, intonation: 93, energy: 91, emphasis: 99, pause: 58 }
    },
    dspProfile: { lowGain: 1.8, midFreq: 1100, midGain: 2.6, presenceFreq: 3600, presenceGain: 4.8, highGain: 2.8, reverb: 0.04, reverbDecay: 0.25, compressor: { threshold: -21, ratio: 4.2, attack: 0.004, release: 0.14 } }
  },
  {
    ...
    rate: 1.03,
    recommendedFor: 'both',
    desc: 'Giọng nữ gần gũi như người bạn tri kỷ, chia sẻ thật lòng, độ tin cậy tự nhiên cao, khiến khách hàng an tâm mua sắm.',
    sampleText: 'Bà nào da nhạy cảm giống tui thì bơi vô đây nha, dùng em này êm ru mà cấp ẩm đỉnh chóp luôn, không mua là tiếc đứt ruột đó!',
    edgePitch: '+4%',
    edgeRate: '+3%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH_NEUTRAL', accent: 'Southern Friendly', accent_strength: 50 },
      persona: { age: '24-32', personality: 'thân thiết, chân thật', authority: 65, friendliness: 100 },
      style: { primary: 'conversational_sales', secondary: ['review_daily', 'friend_vibe'] },
      emotion: { warmth: 97, happiness: 88, excitement: 76, confidence: 82, urgency: 35, empathy: 91 },
      acoustic: { pitch: 70, depth: 36, warmth: 97, resonance: 45, breathiness: 24, clarity: 90, articulation: 88, speed: 78, rhythm: 82, intonation: 90, energy: 79, emphasis: 76, pause: 46 }
    },
    dspProfile: { lowGain: 0.2, midFreq: 1350, midGain: 2.5, presenceFreq: 4000, presenceGain: 4.2, highGain: 3.0, reverb: 0.05, reverbDecay: 0.30, compressor: { threshold: -17, ratio: 3.0, attack: 0.010, release: 0.22 } }
  },
  {
    id: 'vn_f_sales_luxury_08',
    name: '[NEW] 08. Nữ Bán Hàng Cao Cấp 👑 (VN-F-SALES-LUXURY)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.96,
    recommendedFor: 'both',
    desc: 'Giọng nữ quý phái, điềm đạm, tôn vinh giá trị sản phẩm xa xỉ, mang lại cảm giác đẳng cấp và độc bản cho người mua.',
    sampleText: 'Mỗi chi tiết trên sản phẩm đều được chế tác thủ công tinh xảo, thể hiện đẳng cấp vượt trội và phong cách sống thượng lưu của quý khách.',
    edgePitch: '-5%',
    edgeRate: '-4%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Elegance', accent_strength: 60 },
      persona: { age: '30-40', personality: 'sang trọng, điềm tĩnh', authority: 92, friendliness: 75 },
      style: { primary: 'luxury_sales', secondary: ['high_end', 'calm_closing'] },
      emotion: { warmth: 83, happiness: 58, excitement: 55, confidence: 96, urgency: 30, empathy: 80 },
      acoustic: { pitch: 52, depth: 64, warmth: 83, resonance: 82, breathiness: 12, clarity: 98, articulation: 96, speed: 61, rhythm: 65, intonation: 70, energy: 65, emphasis: 81, pause: 76 }
    },
    dspProfile: { lowGain: 3.2, midFreq: 900, midGain: 2.8, presenceFreq: 3200, presenceGain: 4.0, highGain: 1.8, reverb: 0.07, reverbDecay: 0.40, compressor: { threshold: -16, ratio: 3.2, attack: 0.012, release: 0.25 } }
  },
  {
    id: 'vn_f_sales_fomo_09',
    name: '[NEW] 09. Nữ Chốt Sale Tạo Khẩn Cấp FOMO 👑 (VN-F-SALES-FOMO)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.09,
    recommendedFor: 'both',
    desc: 'Giọng nữ dồn dập, tạo sức ép khan hiếm cực cao, kích hoạt tâm lý sợ bỏ lỡ cơ hội vàng, chốt sạch kho trong nháy mắt.',
    sampleText: 'Chỉ còn đúng 30 giây cuối cùng thôi ạ! Hết 10 suất này là giá trở về nguyên gốc, các bác nhanh tay bấm Mua Kẻo Hết ngay bây giờ!',
    edgePitch: '+7%',
    edgeRate: '+9%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Fast', accent_strength: 52 },
      persona: { age: '23-30', personality: 'kịch tính, sôi động', authority: 75, friendliness: 85 },
      style: { primary: 'urgency_sales', secondary: ['fomo_closing', 'flash_countdown'] },
      emotion: { warmth: 76, happiness: 85, excitement: 94, confidence: 94, urgency: 100, empathy: 65 },
      acoustic: { pitch: 74, depth: 33, warmth: 76, resonance: 52, breathiness: 14, clarity: 94, articulation: 92, speed: 89, rhythm: 93, intonation: 96, energy: 94, emphasis: 100, pause: 35 }
    },
    dspProfile: { lowGain: -0.5, midFreq: 1400, midGain: 3.0, presenceFreq: 4300, presenceGain: 5.5, highGain: 4.0, reverb: 0.03, reverbDecay: 0.22, compressor: { threshold: -23, ratio: 4.8, attack: 0.002, release: 0.10 } }
  },
  {
    id: 'vn_f_sales_expert_10',
    name: '[NEW] 10. Nữ Chuyên Gia Tư Vấn 👑 (VN-F-SALES-EXPERT)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.99,
    recommendedFor: 'both',
    desc: 'Giọng nữ chuẩn mực học thuật, phân tích chuyên môn sắc bén, tạo uy tín tuyệt đối cho các ngành y tế, mỹ phẩm, công nghệ.',
    sampleText: 'Dựa trên phân tích khoa học và cơ chế hoạt động chuyên sâu, đây là giải pháp tối ưu nhất để khắc phục triệt để vấn đề mà bạn đang gặp phải.',
    edgePitch: '-3%',
    edgeRate: '-1%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'VIETNAMESE_NEUTRAL', accent: 'Standard Professional', accent_strength: 40 },
      persona: { age: '30-42', personality: 'chuyên nghiệp, chuẩn mực', authority: 98, friendliness: 78 },
      style: { primary: 'expert_sales', secondary: ['consulting', 'technical_explanation'] },
      emotion: { warmth: 78, happiness: 60, excitement: 62, confidence: 96, urgency: 45, empathy: 82 },
      acoustic: { pitch: 55, depth: 57, warmth: 78, resonance: 74, breathiness: 6, clarity: 99, articulation: 99, speed: 68, rhythm: 69, intonation: 74, energy: 67, emphasis: 86, pause: 70 }
    },
    dspProfile: { lowGain: 2.5, midFreq: 980, midGain: 2.6, presenceFreq: 3400, presenceGain: 4.4, highGain: 2.0, reverb: 0.05, reverbDecay: 0.30, compressor: { threshold: -18, ratio: 3.6, attack: 0.008, release: 0.18 } }
  },
  {
    id: 'vn_f_sales_cute_11',
    name: '[NEW] 11. Cô Gái Trẻ Dễ Thương 👑 (VN-F-SALES-CUTE)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.04,
    recommendedFor: 'idol',
    desc: 'Giọng nữ trẻ trung, trong trẻo, nũng nịu đáng yêu, rất thu hút giới trẻ, chuyên thời trang, phụ kiện, đồ ăn vặt dễ thương.',
    sampleText: 'Hi cả nhà iu ơi! Mẫu này cưng xỉu luôn á, em mặc thử lên ai cũng khen tấm tắc, mọi người nhanh tay rinh về nha!',
    edgePitch: '+12%',
    edgeRate: '+4%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Cute', accent_strength: 60 },
      persona: { age: '18-25', personality: 'dễ thương, nhí nhảnh', authority: 55, friendliness: 98 },
      style: { primary: 'cute_sales', secondary: ['genz_vibe', 'sweet_recommend'] },
      emotion: { warmth: 93, happiness: 94, excitement: 88, confidence: 75, urgency: 40, empathy: 85 },
      acoustic: { pitch: 84, depth: 22, warmth: 93, resonance: 38, breathiness: 30, clarity: 89, articulation: 87, speed: 80, rhythm: 84, intonation: 97, energy: 89, emphasis: 82, pause: 39 }
    },
    dspProfile: { lowGain: -1.5, midFreq: 1600, midGain: 3.5, presenceFreq: 4800, presenceGain: 6.0, highGain: 4.8, reverb: 0.08, reverbDecay: 0.38, compressor: { threshold: -19, ratio: 3.5, attack: 0.006, release: 0.16 } }
  },
  {
    id: 'vn_f_sales_mature_12',
    name: '[NEW] 12. Phụ Nữ Trưởng Thành Bán Hàng 👑 (VN-F-SALES-MATURE)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.98,
    recommendedFor: 'both',
    desc: 'Giọng phụ nữ trung niên đằm thắm, chín chắn, thấu hiểu tâm lý, chuyên dòng chăm sóc sức khỏe, bảo hiểm, phong thủy.',
    sampleText: 'Ở độ tuổi này sức khỏe là vốn quý nhất các anh chị ạ. Sản phẩm này em và gia đình đã dùng suốt 3 năm nay thấy rất hiệu quả.',
    edgePitch: '-9%',
    edgeRate: '-2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH_NEUTRAL', accent: 'Southern Mature', accent_strength: 55 },
      persona: { age: '38-50', personality: 'trưởng thành, chu đáo', authority: 91, friendliness: 88 },
      style: { primary: 'mature_sales', secondary: ['health_wellness', 'family_consulting'] },
      emotion: { warmth: 91, happiness: 65, excitement: 50, confidence: 95, urgency: 35, empathy: 95 },
      acoustic: { pitch: 46, depth: 70, warmth: 91, resonance: 83, breathiness: 8, clarity: 97, articulation: 96, speed: 65, rhythm: 67, intonation: 70, energy: 68, emphasis: 84, pause: 72 }
    },
    dspProfile: { lowGain: 4.0, midFreq: 880, midGain: 2.8, presenceFreq: 3100, presenceGain: 3.8, highGain: 1.5, reverb: 0.06, reverbDecay: 0.35, compressor: { threshold: -17, ratio: 3.2, attack: 0.010, release: 0.22 } }
  },
  {
    id: 'vn_f_sales_fast_13',
    name: '[NEW] 13. Nữ Sale Tốc Độ Cao 👑 (VN-F-SALES-FAST)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.15,
    recommendedFor: 'both',
    desc: 'Giọng nữ nói siêu nhanh, rõ từng chữ, nhịp bắn liên thanh cuốn hút không ngắt quãng, tạo không khí bán hàng sôi sục.',
    sampleText: 'Mã số một áo thun cotton 100k hai cái, mã số hai quần jean co giãn 150k, mọi người comment mã kèm số điện thoại để chốt liền nha!',
    edgePitch: '+5%',
    edgeRate: '+15%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Rapid', accent_strength: 55 },
      persona: { age: '22-30', personality: 'nhanh nhẹn, linh hoạt', authority: 78, friendliness: 86 },
      style: { primary: 'rapid_sales', secondary: ['fast_auction', 'continuous_stream'] },
      emotion: { warmth: 76, happiness: 88, excitement: 95, confidence: 90, urgency: 95, empathy: 60 },
      acoustic: { pitch: 71, depth: 31, warmth: 76, resonance: 46, breathiness: 8, clarity: 94, articulation: 92, speed: 99, rhythm: 97, intonation: 91, energy: 98, emphasis: 94, pause: 18 }
    },
    dspProfile: { lowGain: -0.8, midFreq: 1400, midGain: 2.8, presenceFreq: 4400, presenceGain: 5.6, highGain: 4.0, reverb: 0.02, reverbDecay: 0.18, compressor: { threshold: -24, ratio: 5.0, attack: 0.002, release: 0.08 } }
  },
  {
    id: 'vn_f_sales_trust_14',
    name: '[NEW] 14. Nữ Tạo Niềm Tin 👑 (VN-F-SALES-TRUST)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.98,
    recommendedFor: 'both',
    desc: 'Giọng nữ chân phương, đáng tin cậy, giọng điệu ấm áp xóa tan mọi hoài nghi của khách hàng về chất lượng và bảo hành.',
    sampleText: 'Bên em bảo hành chính hãng hai năm lỗi một đổi một tận nhà. Các bác nhận hàng cứ kiểm tra thoải mái rồi mới thanh toán ạ.',
    edgePitch: '-3%',
    edgeRate: '-2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Trust', accent_strength: 58 },
      persona: { age: '30-40', personality: 'trung thực, chân thành', authority: 86, friendliness: 92 },
      style: { primary: 'trust_sales', secondary: ['warranty_assurance', 'customer_peace'] },
      emotion: { warmth: 94, happiness: 68, excitement: 55, confidence: 95, urgency: 30, empathy: 92 },
      acoustic: { pitch: 55, depth: 54, warmth: 94, resonance: 72, breathiness: 7, clarity: 98, articulation: 97, speed: 67, rhythm: 68, intonation: 73, energy: 62, emphasis: 78, pause: 74 }
    },
    dspProfile: { lowGain: 2.2, midFreq: 1000, midGain: 2.6, presenceFreq: 3400, presenceGain: 4.2, highGain: 2.0, reverb: 0.05, reverbDecay: 0.30, compressor: { threshold: -17, ratio: 3.2, attack: 0.010, release: 0.20 } }
  },
  {
    id: 'vn_f_sales_host_15',
    name: '[NEW] 15. Nữ MC Livestream 👑 (VN-F-SALES-HOST)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.03,
    recommendedFor: 'both',
    desc: 'Giọng MC dẫn dắt sự kiện livestream bài bản, chuyển ý mượt mà, phong thái đài các, làm chủ mọi kịch bản bán hàng.',
    sampleText: 'Chào mừng quý khán giả đang quay trở lại với đại tiệc săn sale hoành tráng nhất tối hôm nay! Rất nhiều quà tặng hấp dẫn đang chờ đón mọi người!',
    edgePitch: '+3%',
    edgeRate: '+3%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH_NEUTRAL', accent: 'Southern Host', accent_strength: 50 },
      persona: { age: '25-35', personality: 'duyên dáng, làm chủ sân khấu', authority: 88, friendliness: 90 },
      style: { primary: 'live_host', secondary: ['event_moderation', 'sales_flow'] },
      emotion: { warmth: 86, happiness: 85, excitement: 88, confidence: 93, urgency: 60, empathy: 80 },
      acoustic: { pitch: 67, depth: 40, warmth: 86, resonance: 69, breathiness: 10, clarity: 98, articulation: 97, speed: 79, rhythm: 91, intonation: 95, energy: 90, emphasis: 91, pause: 45 }
    },
    dspProfile: { lowGain: 0.8, midFreq: 1250, midGain: 2.6, presenceFreq: 3800, presenceGain: 4.8, highGain: 3.2, reverb: 0.06, reverbDecay: 0.32, compressor: { threshold: -19, ratio: 3.8, attack: 0.006, release: 0.16 } }
  },
  {
    id: 'vn_f_sales_emotional_16',
    name: '[NEW] 16. Nữ Bán Hàng Giàu Cảm Xúc 👑 (VN-F-SALES-EMOTIONAL)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.98,
    recommendedFor: 'both',
    desc: 'Giọng nữ sâu sắc truyền cảm, nói từ trái tim, chạm đến cảm xúc sâu kín, phù hợp quà tặng, gia đình, mẹ và bé.',
    sampleText: 'Một món quà nhỏ nhưng chứa đựng trọn vẹn tình yêu thương của bạn dành cho những người thân yêu nhất trong gia đình.',
    edgePitch: '+3%',
    edgeRate: '-2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Emotional', accent_strength: 55 },
      persona: { age: '28-40', personality: 'ấm áp, giàu tình cảm', authority: 75, friendliness: 96 },
      style: { primary: 'emotional_sales', secondary: ['story_selling', 'heartfelt_gift'] },
      emotion: { warmth: 96, happiness: 75, excitement: 60, confidence: 83, urgency: 35, empathy: 96, emotion: 98 },
      acoustic: { pitch: 67, depth: 42, warmth: 96, resonance: 60, breathiness: 25, clarity: 91, articulation: 89, speed: 67, rhythm: 76, intonation: 94, energy: 80, emphasis: 91, pause: 68 }
    },
    dspProfile: { lowGain: 1.2, midFreq: 1150, midGain: 2.8, presenceFreq: 3600, presenceGain: 4.0, highGain: 2.8, reverb: 0.09, reverbDecay: 0.42, compressor: { threshold: -16, ratio: 3.0, attack: 0.012, release: 0.25 } }
  },
  {
    id: 'vn_f_sales_assertive_17',
    name: '[NEW] 17. Nữ Bán Hàng Quyết Đoán 👑 (VN-F-SALES-ASSERTIVE)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.02,
    recommendedFor: 'both',
    desc: 'Giọng nữ bản lĩnh, đanh thép, chắc nịch từng câu thoại, áp đảo tâm lý ngần ngại, thúc đẩy hành động mua ngay tức khắc.',
    sampleText: 'Đừng chần chừ nữa! Cơ hội chỉ đến một lần và người đưa ra quyết định nhanh nhất sẽ là người nhận được giá trị tuyệt vời nhất!',
    edgePitch: '-3%',
    edgeRate: '+2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Assertive', accent_strength: 62 },
      persona: { age: '30-42', personality: 'bản lĩnh, quyết đoán', authority: 100, friendliness: 70 },
      style: { primary: 'assertive_sales', secondary: ['strong_pitch', 'deal_maker'] },
      emotion: { warmth: 72, happiness: 60, excitement: 78, confidence: 100, urgency: 82, empathy: 65 },
      acoustic: { pitch: 56, depth: 59, warmth: 72, resonance: 79, breathiness: 4, clarity: 98, articulation: 98, speed: 74, rhythm: 79, intonation: 77, energy: 82, emphasis: 96, pause: 65 }
    },
    dspProfile: { lowGain: 2.8, midFreq: 950, midGain: 2.6, presenceFreq: 3300, presenceGain: 4.5, highGain: 2.0, reverb: 0.04, reverbDecay: 0.25, compressor: { threshold: -20, ratio: 4.2, attack: 0.005, release: 0.15 } }
  },
  {
    id: 'vn_f_sales_young_18',
    name: '[NEW] 18. Nữ Gen Z Bán Hàng 👑 (VN-F-SALES-YOUNG)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.08,
    recommendedFor: 'idol',
    desc: 'Giọng nữ Gen Z trẻ trung, sành điệu, bắt trend cực nhạy, phù hợp các sản phẩm thời trang, phụ kiện, mỹ phẩm giới trẻ.',
    sampleText: 'Mấy bà ơi item này đang hot rần rần trên TikTok luôn á, mặc vào là chuẩn visual sang xịn mịn liền nha!',
    edgePitch: '+10%',
    edgeRate: '+8%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern GenZ', accent_strength: 55 },
      persona: { age: '18-25', personality: 'sành điệu, năng động', authority: 65, friendliness: 95 },
      style: { primary: 'GenZ_live_sales', secondary: ['tiktok_trends', 'fashion_youth'] },
      emotion: { warmth: 87, happiness: 94, excitement: 97, confidence: 84, urgency: 65, empathy: 80 },
      acoustic: { pitch: 81, depth: 25, warmth: 87, resonance: 41, breathiness: 23, clarity: 89, articulation: 87, speed: 90, rhythm: 94, intonation: 98, energy: 96, emphasis: 94, pause: 25 }
    },
    dspProfile: { lowGain: -1.0, midFreq: 1500, midGain: 3.2, presenceFreq: 4600, presenceGain: 5.8, highGain: 4.5, reverb: 0.06, reverbDecay: 0.32, compressor: { threshold: -20, ratio: 4.0, attack: 0.004, release: 0.14 } }
  },
  {
    id: 'vn_f_sales_calm_19',
    name: '[NEW] 19. Nữ Bán Hàng Nhẹ Nhàng 👑 (VN-F-SALES-CALM)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.93,
    recommendedFor: 'both',
    desc: 'Giọng nữ êm ái, nhẹ nhàng, từ tốn ru êm lòng người, chuyên các dòng trà đạo, thiền định, tinh dầu, mỹ phẩm organic.',
    sampleText: 'Một tách trà thơm vào buổi sáng sớm sẽ giúp tâm hồn bạn thư thái và khởi đầu một ngày mới thật bình an.',
    edgePitch: '-1%',
    edgeRate: '-7%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH', accent: 'Northern Soft', accent_strength: 65 },
      persona: { age: '28-40', personality: 'dịu dàng, thư thái', authority: 80, friendliness: 95 },
      style: { primary: 'soft_sales', secondary: ['organic_lifestyle', 'zen_products'] },
      emotion: { warmth: 95, happiness: 70, excitement: 40, confidence: 88, urgency: 20, empathy: 94 },
      acoustic: { pitch: 61, depth: 48, warmth: 95, resonance: 61, breathiness: 15, clarity: 96, articulation: 94, speed: 57, rhythm: 61, intonation: 77, energy: 51, emphasis: 70, pause: 82 }
    },
    dspProfile: { lowGain: 1.5, midFreq: 1100, midGain: 2.5, presenceFreq: 3500, presenceGain: 3.8, highGain: 2.2, reverb: 0.10, reverbDecay: 0.45, compressor: { threshold: -15, ratio: 2.8, attack: 0.015, release: 0.30 } }
  },
  {
    id: 'vn_f_sales_viral_20',
    name: '[NEW] 20. Nữ TikTok Viral Triệu View 👑 (VN-F-SALES-VIRAL)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.11,
    recommendedFor: 'idol',
    desc: 'Giọng nữ viral bùng nổ, bắt tai đến từng nốt, năng lượng cực đại giữ chân người xem không thể rời mắt khỏi màn hình.',
    sampleText: 'Đừng vội lướt qua nha! Bí mật giúp kênh TikTok của bạn bùng nổ hàng triệu lượt xem nằm ngay trong video này đây!',
    edgePitch: '+8%',
    edgeRate: '+11%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Viral', accent_strength: 55 },
      persona: { age: '20-28', personality: 'cuốn hút, tràn trề năng lượng', authority: 82, friendliness: 94 },
      style: { primary: 'viral_live', secondary: ['retention_master', 'million_views'] },
      emotion: { warmth: 86, happiness: 95, excitement: 99, confidence: 91, urgency: 75, empathy: 70 },
      acoustic: { pitch: 77, depth: 29, warmth: 86, resonance: 43, breathiness: 15, clarity: 91, articulation: 90, speed: 94, rhythm: 98, intonation: 99, energy: 100, emphasis: 98, pause: 22 }
    },
    dspProfile: { lowGain: -0.8, midFreq: 1450, midGain: 3.0, presenceFreq: 4500, presenceGain: 5.6, highGain: 4.2, reverb: 0.05, reverbDecay: 0.28, compressor: { threshold: -22, ratio: 4.6, attack: 0.003, release: 0.12 } }
  },

  // --- 20 GIỌNG NỮ ĐA DỤNG: DOANH NHÂN, QUẢNG CÁO, KỂ CHUYỆN, PODCAST, MC ---
  {
    id: 'vn_f_ceo_21',
    name: '[NEW] 21. Nữ CEO Quyền Lực 👑 (VN-F-CEO)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    ageGroup: 'middle',
    styleCategory: 'sales_services',
    category: '🔥 [NEW] Doanh Nhân & Chuyên Gia',
    pitch: 0.92,
    rate: 0.97,
    recommendedFor: 'both',
    desc: 'Giọng nữ lãnh đạo cấp cao, uy quyền, điềm tĩnh, lời nói sắc lẹm đĩnh đạc, truyền tải tầm nhìn chiến lược doanh nghiệp.',
    sampleText: 'Chiến lược của chúng tôi là dẫn đầu thị trường bằng sự đổi mới không ngừng và mang lại giá trị bền vững cho đối tác.',
    edgePitch: '-8%',
    edgeRate: '-3%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Executive', accent_strength: 65 },
      persona: { age: '38-50', personality: 'uy quyền, quyết đoán', authority: 100, friendliness: 68 },
      style: { primary: 'executive', secondary: ['strategic_speech', 'corporate_vision'] },
      emotion: { warmth: 74, happiness: 50, excitement: 45, confidence: 100, urgency: 30, empathy: 70 },
      acoustic: { pitch: 48, depth: 72, warmth: 74, resonance: 87, breathiness: 3, clarity: 99, articulation: 99, speed: 62, rhythm: 65, intonation: 69, energy: 67, emphasis: 86, pause: 82 }
    },
    dspProfile: { lowGain: 4.2, midFreq: 850, midGain: 3.0, presenceFreq: 3000, presenceGain: 4.0, highGain: 1.2, reverb: 0.06, reverbDecay: 0.35, compressor: { threshold: -18, ratio: 3.8, attack: 0.008, release: 0.20 } }
  },
  {
    id: 'vn_f_founder_22',
    name: '[NEW] 22. Nữ Doanh Nhân Truyền Cảm Hứng 👑 (VN-F-FOUNDER)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.01,
    recommendedFor: 'both',
    desc: 'Giọng nữ founder nhiệt huyết, truyền cảm hứng khởi nghiệp, năng lượng tích cực lan tỏa khát vọng vươn lên.',
    sampleText: 'Thành công không phải là điểm đến mà là hành trình chúng ta dám vượt qua giới hạn của chính mình để bứt phá.',
    edgePitch: '-2%',
    edgeRate: '+1%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'VIETNAMESE_NEUTRAL', accent: 'Standard Inspiration', accent_strength: 45 },
      persona: { age: '30-45', personality: 'nhiệt huyết, tự tin', authority: 91, friendliness: 85 },
      style: { primary: 'founder_story', secondary: ['startup_inspiration', 'business_pitch'] },
      emotion: { warmth: 82, happiness: 80, excitement: 85, confidence: 98, urgency: 50, empathy: 85 },
      acoustic: { pitch: 57, depth: 55, warmth: 82, resonance: 72, breathiness: 8, clarity: 97, articulation: 96, speed: 70, rhythm: 76, intonation: 82, energy: 86, emphasis: 90, pause: 62 }
    },
    dspProfile: { lowGain: 2.4, midFreq: 1050, midGain: 2.8, presenceFreq: 3500, presenceGain: 4.6, highGain: 2.4, reverb: 0.05, reverbDecay: 0.30, compressor: { threshold: -19, ratio: 3.6, attack: 0.006, release: 0.16 } }
  },
  {
    id: 'vn_f_ad_luxury_23',
    name: '[NEW] 23. Quảng Cáo Thương Hiệu Cao Cấp 👑 (VN-F-AD-LUXURY)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.92,
    recommendedFor: 'both',
    desc: 'Giọng TVC quảng cáo xe sang, bất động sản nghỉ dưỡng, trang sức cao cấp, nhịp điệu chậm rãi quý phái chuẩn điện ảnh.',
    sampleText: 'Khẳng định vị thế độc tôn và tận hưởng không gian sống tinh hoa xứng tầm đẳng cấp tại dinh thự ven sông.',
    edgePitch: '-6%',
    edgeRate: '-8%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Luxury Ad', accent_strength: 65 },
      persona: { age: '30-45', personality: 'quý phái, trầm tĩnh', authority: 95, friendliness: 70 },
      style: { primary: 'luxury_advertising', secondary: ['tvc_voiceover', 'cinematic_ad'] },
      emotion: { warmth: 82, happiness: 55, excitement: 50, confidence: 95, urgency: 20, empathy: 75 },
      acoustic: { pitch: 51, depth: 66, warmth: 82, resonance: 88, breathiness: 10, clarity: 99, articulation: 98, speed: 54, rhythm: 58, intonation: 68, energy: 57, emphasis: 76, pause: 85 }
    },
    dspProfile: { lowGain: 3.8, midFreq: 880, midGain: 3.0, presenceFreq: 3100, presenceGain: 4.2, highGain: 1.8, reverb: 0.08, reverbDecay: 0.45, compressor: { threshold: -16, ratio: 3.2, attack: 0.012, release: 0.26 } }
  },
  {
    id: 'vn_f_ad_beauty_24',
    name: '[NEW] 24. Quảng Cáo Làm Đẹp & Mỹ Phẩm 👑 (VN-F-AD-BEAUTY)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.98,
    recommendedFor: 'idol',
    desc: 'Giọng quảng cáo spa, mỹ phẩm, thẩm mỹ viện ngọt ngào mềm mượt như lụa, hơi thở ASMR lôi cuốn mê hoặc.',
    sampleText: 'Đánh thức vẻ đẹp rạng ngời từ sâu bên trong tế bào, cho làn da căng bóng mịn màng không tì vết.',
    edgePitch: '+4%',
    edgeRate: '-2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Beauty Ad', accent_strength: 55 },
      persona: { age: '25-35', personality: 'mềm mại, quyến rũ', authority: 78, friendliness: 95 },
      style: { primary: 'beauty_ad', secondary: ['skincare_tvc', 'spa_asmr'] },
      emotion: { warmth: 94, happiness: 85, excitement: 70, confidence: 89, urgency: 30, empathy: 90 },
      acoustic: { pitch: 70, depth: 34, warmth: 94, resonance: 59, breathiness: 24, clarity: 95, articulation: 93, speed: 65, rhythm: 70, intonation: 86, energy: 72, emphasis: 80, pause: 65 }
    },
    dspProfile: { lowGain: -0.2, midFreq: 1350, midGain: 2.8, presenceFreq: 4200, presenceGain: 5.2, highGain: 4.5, reverb: 0.08, reverbDecay: 0.40, compressor: { threshold: -18, ratio: 3.4, attack: 0.008, release: 0.20 } }
  },
  {
    id: 'vn_f_ad_tech_25',
    name: '[NEW] 25. Quảng Cáo Công Nghệ AI 👑 (VN-F-AD-TECH)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.01,
    recommendedFor: 'both',
    desc: 'Giọng quảng cáo công nghệ, trí tuệ nhân tạo, thiết bị thông minh, âm sắc sắc nét hiện đại và chuẩn xác.',
    sampleText: 'Trải nghiệm sức mạnh đột phá của thế hệ AI mới, tối ưu hóa toàn diện hiệu suất làm việc của bạn trong tương lai.',
    edgePitch: '-2%',
    edgeRate: '+1%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'VIETNAMESE_NEUTRAL', accent: 'Standard Tech', accent_strength: 40 },
      persona: { age: '27-40', personality: 'hiện đại, chuẩn xác', authority: 94, friendliness: 80 },
      style: { primary: 'technology_ad', secondary: ['ai_voice', 'smart_device'] },
      emotion: { warmth: 75, happiness: 65, excitement: 78, confidence: 95, urgency: 45, empathy: 70 },
      acoustic: { pitch: 58, depth: 52, warmth: 75, resonance: 76, breathiness: 5, clarity: 99, articulation: 99, speed: 72, rhythm: 74, intonation: 76, energy: 73, emphasis: 83, pause: 62 }
    },
    dspProfile: { lowGain: 1.5, midFreq: 1150, midGain: 2.6, presenceFreq: 3800, presenceGain: 4.8, highGain: 3.0, reverb: 0.04, reverbDecay: 0.25, compressor: { threshold: -19, ratio: 3.8, attack: 0.005, release: 0.15 } }
  },
  {
    id: 'vn_f_motivation_26',
    name: '[NEW] 26. Nữ Truyền Động Lực 👑 (VN-F-MOTIVATION)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.99,
    recommendedFor: 'both',
    desc: 'Giọng nữ truyền lửa mạnh mẽ, đầy nội lực, khơi dậy niềm tin và sức mạnh nội tại giúp người nghe vượt qua thử thách.',
    sampleText: 'Đừng bao giờ từ bỏ ước mơ của mình! Mỗi ngày mới là một cơ hội để bạn viết tiếp câu chuyện vĩ đại của cuộc đời bạn.',
    edgePitch: '-2%',
    edgeRate: '-1%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Motivational', accent_strength: 60 },
      persona: { age: '30-45', personality: 'mạnh mẽ, tràn đầy cảm hứng', authority: 94, friendliness: 85 },
      style: { primary: 'motivational', secondary: ['life_coaching', 'inner_strength'] },
      emotion: { warmth: 84, happiness: 85, excitement: 92, confidence: 98, positivity: 98, urgency: 50, empathy: 88 },
      acoustic: { pitch: 57, depth: 58, warmth: 84, resonance: 78, breathiness: 5, clarity: 97, articulation: 96, speed: 67, rhythm: 72, intonation: 87, energy: 92, emphasis: 96, pause: 68 }
    },
    dspProfile: { lowGain: 2.6, midFreq: 1000, midGain: 2.8, presenceFreq: 3500, presenceGain: 4.6, highGain: 2.5, reverb: 0.06, reverbDecay: 0.35, compressor: { threshold: -20, ratio: 4.0, attack: 0.005, release: 0.16 } }
  },
  {
    id: 'vn_f_story_warm_27',
    name: '[NEW] 27. Nữ Kể Chuyện Ấm Áp 👑 (VN-F-STORY-WARM)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    ageGroup: 'young',
    styleCategory: 'sales_services',
    category: '🔥 [NEW] Kể Chuyện & Cảm Xúc',
    pitch: 0.98,
    rate: 0.92,
    recommendedFor: 'both',
    desc: 'Giọng đọc truyện đêm khuya, podcast chữa lành, du dương ấm áp như tiếng ru nhẹ nhàng xoa dịu tâm hồn.',
    sampleText: 'Đêm đã về khuya, hãy gác lại những âu lo thường nhật, nhắm mắt lại và để cho tâm hồn mình được nghỉ ngơi bình yên.',
    edgePitch: '-2%',
    edgeRate: '-8%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Story', accent_strength: 55 },
      persona: { age: '30-45', personality: 'ấm áp, lắng đọng', authority: 75, friendliness: 98 },
      style: { primary: 'warm_storytelling', secondary: ['audiobook', 'healing_podcast'] },
      emotion: { warmth: 98, happiness: 70, excitement: 35, confidence: 85, empathy: 96, emotion: 94 },
      acoustic: { pitch: 57, depth: 52, warmth: 98, resonance: 65, breathiness: 22, clarity: 94, articulation: 92, speed: 55, rhythm: 61, intonation: 88, energy: 52, emphasis: 72, pause: 88 }
    },
    dspProfile: { lowGain: 2.0, midFreq: 1100, midGain: 2.6, presenceFreq: 3400, presenceGain: 3.8, highGain: 2.0, reverb: 0.11, reverbDecay: 0.48, compressor: { threshold: -15, ratio: 2.8, attack: 0.015, release: 0.30 } }
  },
  {
    id: 'vn_f_story_cinema_28',
    name: '[NEW] 28. Nữ Kể Chuyện Điện Ảnh 👑 (VN-F-STORY-CINEMA)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.89,
    recommendedFor: 'both',
    desc: 'Giọng kể chuyện phim điện ảnh, review phim bom tấn, ma mị, sâu lắng, đưa người nghe lạc vào thế giới màn bạc.',
    sampleText: 'Giữa màn sương mờ ảo của thành phố cổ kính, một bóng người bí ẩn xuất hiện, mở ra bí mật kinh hoàng đã bị chôn vùi suốt thế kỷ.',
    edgePitch: '-7%',
    edgeRate: '-11%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Cinematic', accent_strength: 65 },
      persona: { age: '30-45', personality: 'bí ẩn, sâu lắng', authority: 90, friendliness: 72 },
      style: { primary: 'cinematic_storytelling', secondary: ['movie_review', 'drama_narrative'] },
      emotion: { warmth: 77, happiness: 45, excitement: 65, confidence: 92, emotional_depth: 95, empathy: 80 },
      acoustic: { pitch: 49, depth: 67, warmth: 77, resonance: 91, breathiness: 12, clarity: 96, articulation: 94, speed: 50, rhythm: 57, intonation: 82, energy: 64, emphasis: 89, pause: 94 }
    },
    dspProfile: { lowGain: 3.8, midFreq: 880, midGain: 3.0, presenceFreq: 3100, presenceGain: 4.2, highGain: 1.8, reverb: 0.12, reverbDecay: 0.52, compressor: { threshold: -17, ratio: 3.5, attack: 0.010, release: 0.25 } }
  },
  {
    id: 'vn_f_documentary_29',
    name: '[NEW] 29. Nữ Thuyết Minh Documentary 👑 (VN-F-DOCUMENTARY)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.95,
    recommendedFor: 'both',
    desc: 'Giọng thuyết minh phim tài liệu, lịch sử, khám phá thiên nhiên Discovery & National Geographic chuẩn mực truyền hình.',
    sampleText: 'Trải qua hàng triệu năm kiến tạo địa chất, vùng đất này đã trở thành ngôi nhà trú ngụ của hàng ngàn loài sinh vật quý hiếm nhất hành tinh.',
    edgePitch: '-6%',
    edgeRate: '-5%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'VIETNAMESE_NEUTRAL', accent: 'Standard Documentary', accent_strength: 40 },
      persona: { age: '32-50', personality: 'học thuật, chuẩn mực', authority: 95, friendliness: 75 },
      style: { primary: 'documentary', secondary: ['history_nature', 'tv_narration'] },
      emotion: { warmth: 78, happiness: 50, excitement: 55, confidence: 95, urgency: 25, empathy: 75 },
      acoustic: { pitch: 51, depth: 61, warmth: 78, resonance: 80, breathiness: 4, clarity: 99, articulation: 99, speed: 59, rhythm: 63, intonation: 70, energy: 55, emphasis: 76, pause: 75 }
    },
    dspProfile: { lowGain: 3.0, midFreq: 950, midGain: 2.8, presenceFreq: 3300, presenceGain: 4.2, highGain: 2.0, reverb: 0.07, reverbDecay: 0.38, compressor: { threshold: -18, ratio: 3.5, attack: 0.008, release: 0.20 } }
  },
  {
    id: 'vn_f_news_30',
    name: '[NEW] 30. Nữ Đọc Tin Thời Sự VTV 👑 (VN-F-NEWS)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    ageGroup: 'young',
    styleCategory: 'sales_services',
    category: '🔥 [NEW] MC, Bản Tin & CSKH',
    pitch: 0.97,
    rate: 0.99,
    recommendedFor: 'both',
    desc: 'Giọng phát thanh viên bản tin thời sự VTV, chuẩn giọng Hà Nội mực thước, ngữ điệu trang trọng, phát âm chuẩn 100%.',
    sampleText: 'Kính chào quý vị và các bạn! Mời quý vị cùng theo dõi bản tin thời sự tổng hợp với những tin tức kinh tế xã hội nổi bật nhất trong ngày.',
    edgePitch: '-3%',
    edgeRate: '-1%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_STANDARD', accent: 'Northern News Standard', accent_strength: 75 },
      persona: { age: '28-45', personality: 'trang trọng, mực thước', authority: 94, friendliness: 70 },
      style: { primary: 'news', secondary: ['broadcast_news', 'official_report'] },
      emotion: { warmth: 65, happiness: 45, excitement: 40, confidence: 96, emotion: 28, urgency: 35, empathy: 60 },
      acoustic: { pitch: 55, depth: 50, warmth: 65, resonance: 67, breathiness: 2, clarity: 100, articulation: 100, speed: 68, rhythm: 73, intonation: 68, energy: 62, emphasis: 70, pause: 59 }
    },
    dspProfile: { lowGain: 1.8, midFreq: 1000, midGain: 2.5, presenceFreq: 3500, presenceGain: 4.8, highGain: 2.2, reverb: 0.04, reverbDecay: 0.25, compressor: { threshold: -19, ratio: 3.8, attack: 0.005, release: 0.16 } }
  },
  {
    id: 'vn_f_mc_elegant_31',
    name: '[NEW] 31. MC Nữ Sang Trọng 👑 (VN-F-MC-ELEGANT)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.00,
    recommendedFor: 'both',
    desc: 'Giọng MC nữ gala dạ tiệc, lễ trao giải danh giá, quý phái đài các, phong thái đỉnh đạc cuốn hút mọi ánh nhìn.',
    sampleText: 'Hân hoan chào đón toàn thể quý vị đại biểu và khách quý đã có mặt trong đêm đại tiệc vinh danh những tài năng xuất sắc nhất năm.',
    edgePitch: '-1%',
    edgeRate: '+0%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Elegant MC', accent_strength: 65 },
      persona: { age: '28-40', personality: 'đài các, duyên dáng', authority: 91, friendliness: 85 },
      style: { primary: 'elegant_mc', secondary: ['gala_awards', 'formal_event'] },
      emotion: { warmth: 85, happiness: 80, excitement: 75, confidence: 97, urgency: 30, empathy: 80 },
      acoustic: { pitch: 61, depth: 47, warmth: 85, resonance: 79, breathiness: 8, clarity: 99, articulation: 99, speed: 69, rhythm: 86, intonation: 91, energy: 80, emphasis: 84, pause: 60 }
    },
    dspProfile: { lowGain: 1.5, midFreq: 1100, midGain: 2.6, presenceFreq: 3700, presenceGain: 4.8, highGain: 2.8, reverb: 0.08, reverbDecay: 0.40, compressor: { threshold: -18, ratio: 3.6, attack: 0.007, release: 0.18 } }
  },
  {
    id: 'vn_f_mc_energy_32',
    name: '[NEW] 32. MC Nữ Sự Kiện Bùng Nổ 👑 (VN-F-MC-ENERGY)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.07,
    recommendedFor: 'both',
    desc: 'Giọng MC hoạt náo sự kiện ngoài trời, festival âm nhạc, năng lượng rực cháy, khuấy động không khí cực kỳ sôi động.',
    sampleText: 'Cả nhà mình ơi hãy cùng giơ cao cánh tay và đếm ngược theo nhịp điệu để chào đón khoảnh khắc bùng nổ nhất đêm nay nào!',
    edgePitch: '+5%',
    edgeRate: '+7%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH_NEUTRAL', accent: 'Southern Event MC', accent_strength: 52 },
      persona: { age: '24-35', personality: 'năng động, bùng nổ', authority: 86, friendliness: 95 },
      style: { primary: 'event_mc', secondary: ['festival_host', 'crowd_hyping'] },
      emotion: { warmth: 81, happiness: 95, excitement: 96, confidence: 96, urgency: 75, empathy: 75 },
      acoustic: { pitch: 72, depth: 32, warmth: 81, resonance: 55, breathiness: 6, clarity: 97, articulation: 96, speed: 87, rhythm: 94, intonation: 97, energy: 99, emphasis: 94, pause: 35 }
    },
    dspProfile: { lowGain: -0.5, midFreq: 1350, midGain: 2.8, presenceFreq: 4200, presenceGain: 5.4, highGain: 3.8, reverb: 0.06, reverbDecay: 0.30, compressor: { threshold: -21, ratio: 4.4, attack: 0.003, release: 0.12 } }
  },
  {
    id: 'vn_f_expert_33',
    name: '[NEW] 33. Nữ Chuyên Gia Đa Ngành 👑 (VN-F-EXPERT)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.98,
    recommendedFor: 'both',
    desc: 'Giọng nữ chuyên gia cố vấn tài chính, chiến lược, giáo dục cao cấp, tri thức sâu rộng, đĩnh đạc và thuyết phục.',
    sampleText: 'Việc quản trị rủi ro và phân bổ nguồn lực hợp lý là yếu tố then chốt quyết định sự thành bại trong giai đoạn chuyển đổi số.',
    edgePitch: '-4%',
    edgeRate: '-2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'VIETNAMESE_NEUTRAL', accent: 'Standard Senior Expert', accent_strength: 38 },
      persona: { age: '35-50', personality: 'tri thức, chuẩn mực', authority: 100, friendliness: 72 },
      style: { primary: 'expert', secondary: ['advisory', 'strategic_counsel'] },
      emotion: { warmth: 70, happiness: 55, excitement: 50, confidence: 98, urgency: 30, empathy: 75 },
      acoustic: { pitch: 54, depth: 59, warmth: 70, resonance: 77, breathiness: 3, clarity: 100, articulation: 100, speed: 66, rhythm: 68, intonation: 71, energy: 60, emphasis: 84, pause: 73 }
    },
    dspProfile: { lowGain: 2.8, midFreq: 950, midGain: 2.6, presenceFreq: 3300, presenceGain: 4.4, highGain: 1.8, reverb: 0.05, reverbDecay: 0.30, compressor: { threshold: -18, ratio: 3.6, attack: 0.008, release: 0.18 } }
  },
  {
    id: 'vn_f_educator_34',
    name: '[NEW] 34. Nữ Giảng Viên Giáo Dục 👑 (VN-F-EDUCATOR)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.95,
    recommendedFor: 'both',
    desc: 'Giọng nữ cô giáo mẫu mực, ân cần, phát âm tròn vành rõ chữ, nhịp điệu từ tốn giúp người học dễ dàng tiếp thu kiến thức.',
    sampleText: 'Hôm nay cô và các em sẽ cùng nhau tìm hiểu về cấu trúc ngữ pháp quan trọng này để ứng dụng vào bài thi thực tế nhé.',
    edgePitch: '+0%',
    edgeRate: '-5%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Educator', accent_strength: 65 },
      persona: { age: '30-48', personality: 'ân cần, chuẩn mực', authority: 90, friendliness: 92 },
      style: { primary: 'educator', secondary: ['e_learning', 'lecture_course'] },
      emotion: { warmth: 88, happiness: 75, excitement: 60, confidence: 93, urgency: 20, empathy: 90 },
      acoustic: { pitch: 63, depth: 43, warmth: 88, resonance: 61, breathiness: 8, clarity: 98, articulation: 98, speed: 61, rhythm: 65, intonation: 82, energy: 72, emphasis: 81, pause: 72 }
    },
    dspProfile: { lowGain: 1.0, midFreq: 1150, midGain: 2.5, presenceFreq: 3600, presenceGain: 4.5, highGain: 2.5, reverb: 0.06, reverbDecay: 0.32, compressor: { threshold: -17, ratio: 3.2, attack: 0.010, release: 0.20 } }
  },
  {
    id: 'vn_f_customer_care_35',
    name: '[NEW] 35. Nữ Chăm Sóc Khách Hàng 👑 (VN-F-CUSTOMER-CARE)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.95,
    recommendedFor: 'both',
    desc: 'Giọng tổng đài viên chuyên nghiệp, kiên nhẫn, ngọt ngào, tạo cảm giác được quan tâm và chăm sóc tận tình chu đáo.',
    sampleText: 'Dạ em chào anh chị! Em là chuyên viên hỗ trợ của tổng đài, em có thể giúp gì được cho anh chị hôm nay ạ?',
    edgePitch: '+3%',
    edgeRate: '-5%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH_NEUTRAL', accent: 'Southern Customer Care', accent_strength: 52 },
      persona: { age: '25-38', personality: 'tận tâm, kiên nhẫn', authority: 75, friendliness: 100 },
      style: { primary: 'customer_service', secondary: ['call_center', 'support_helpdesk'] },
      emotion: { warmth: 99, happiness: 85, excitement: 50, confidence: 87, empathy: 97, urgency: 20 },
      acoustic: { pitch: 67, depth: 37, warmth: 99, resonance: 50, breathiness: 15, clarity: 96, articulation: 95, speed: 60, rhythm: 63, intonation: 84, energy: 57, emphasis: 61, pause: 69 }
    },
    dspProfile: { lowGain: 0.5, midFreq: 1250, midGain: 2.8, presenceFreq: 3900, presenceGain: 4.8, highGain: 3.0, reverb: 0.05, reverbDecay: 0.30, compressor: { threshold: -17, ratio: 3.0, attack: 0.010, release: 0.20 } }
  },
  {
    id: 'vn_f_empathy_36',
    name: '[NEW] 36. Nữ Trấn An & Đồng Cảm 👑 (VN-F-EMPATHY)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.88,
    recommendedFor: 'both',
    desc: 'Giọng nữ trị liệu tâm lý, chữa lành cảm xúc, hơi thở êm dịu vỗ về, giải tỏa mọi căng thẳng mệt mỏi trong cuộc sống.',
    sampleText: 'Mọi chuyện rồi sẽ ổn thôi bạn nhé. Hãy hít một hơi thật sâu, thở ra nhẹ nhàng và tin rằng bạn luôn xứng đáng được yêu thương.',
    edgePitch: '-3%',
    edgeRate: '-12%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH_NEUTRAL', accent: 'Southern Empathy', accent_strength: 50 },
      persona: { age: '30-45', personality: 'thấu cảm, chữa lành', authority: 80, friendliness: 100 },
      style: { primary: 'empathy', secondary: ['healing_therapy', 'calming_meditation'] },
      emotion: { warmth: 100, empathy: 100, emotional_depth: 97, happiness: 60, excitement: 20, confidence: 80 },
      acoustic: { pitch: 55, depth: 49, warmth: 100, resonance: 57, breathiness: 28, clarity: 92, articulation: 90, speed: 48, rhythm: 54, intonation: 82, energy: 38, emphasis: 55, pause: 91 }
    },
    dspProfile: { lowGain: 1.8, midFreq: 1100, midGain: 2.6, presenceFreq: 3300, presenceGain: 3.5, highGain: 2.2, reverb: 0.12, reverbDecay: 0.50, compressor: { threshold: -14, ratio: 2.5, attack: 0.020, release: 0.35 } }
  },
  {
    id: 'vn_f_friendly_37',
    name: '[NEW] 37. Nữ Bạn Bè Đời Thường 👑 (VN-F-FRIENDLY)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 1.02,
    recommendedFor: 'both',
    desc: 'Giọng nữ trò chuyện hằng ngày, tự nhiên mộc mạc như bạn thân cà phê chém gió, tạo cảm giác vô cùng thân quen.',
    sampleText: 'Nay có chuyện này vui lắm kể mấy bà nghe nè, vừa bước ra đường là gặp ngay tình huống cười xỉu luôn á!',
    edgePitch: '+4%',
    edgeRate: '+2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Casual', accent_strength: 55 },
      persona: { age: '20-35', personality: 'mộc mạc, gần gũi', authority: 60, friendliness: 100 },
      style: { primary: 'casual', secondary: ['vlog_daily', 'friend_chat'] },
      emotion: { warmth: 96, happiness: 90, excitement: 80, confidence: 79, urgency: 30, empathy: 88 },
      acoustic: { pitch: 69, depth: 32, warmth: 96, resonance: 42, breathiness: 20, clarity: 87, articulation: 84, speed: 76, rhythm: 80, intonation: 91, energy: 75, emphasis: 62, pause: 44 }
    },
    dspProfile: { lowGain: 0.0, midFreq: 1300, midGain: 2.4, presenceFreq: 3900, presenceGain: 4.2, highGain: 2.8, reverb: 0.05, reverbDecay: 0.30, compressor: { threshold: -17, ratio: 3.0, attack: 0.010, release: 0.20 } }
  },
  {
    id: 'vn_f_podcast_38',
    name: '[NEW] 38. Nữ Podcast Sâu Lắng 👑 (VN-F-PODCAST)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.94,
    recommendedFor: 'both',
    desc: 'Giọng host podcast chuyên nghiệp, nhịp điệu thư thái, âm sắc dày dặn, đàm đạo các chủ đề phong cách sống và tư duy.',
    sampleText: 'Chào mừng các bạn đến với tập podcast tuần này, nơi chúng ta cùng ngồi lại và suy ngẫm về giá trị của sự kết nối.',
    edgePitch: '-4%',
    edgeRate: '-6%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'VIETNAMESE_NEUTRAL', accent: 'Standard Podcast', accent_strength: 42 },
      persona: { age: '28-42', personality: 'sâu sắc, thư thái', authority: 88, friendliness: 90 },
      style: { primary: 'podcast', secondary: ['lifestyle_talk', 'deep_reflection'] },
      emotion: { warmth: 89, happiness: 65, excitement: 50, confidence: 88, urgency: 25, empathy: 90 },
      acoustic: { pitch: 54, depth: 60, warmth: 89, resonance: 76, breathiness: 18, clarity: 96, articulation: 94, speed: 58, rhythm: 63, intonation: 79, energy: 61, emphasis: 72, pause: 76 }
    },
    dspProfile: { lowGain: 2.8, midFreq: 980, midGain: 2.6, presenceFreq: 3400, presenceGain: 4.4, highGain: 2.2, reverb: 0.08, reverbDecay: 0.38, compressor: { threshold: -17, ratio: 3.4, attack: 0.010, release: 0.22 } }
  },
  {
    id: 'vn_f_emotional_39',
    name: '[NEW] 39. Nữ Tâm Sự Sâu Sắc 👑 (VN-F-EMOTIONAL)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    rate: 0.88,
    recommendedFor: 'both',
    desc: 'Giọng nữ tâm sự đêm muộn, dạt dào cảm xúc thấu hiểu, chạm tới từng góc khuất trong lòng người nghe.',
    sampleText: 'Có những ngày mệt mỏi chỉ ước có một bờ vai để tựa vào, lắng nghe những tâm sự mà chẳng thể nói cùng ai.',
    edgePitch: '-5%',
    edgeRate: '-12%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'NORTH_NEUTRAL', accent: 'Northern Deep Emotional', accent_strength: 62 },
      persona: { age: '30-50', personality: 'sâu sắc, tình cảm', authority: 85, friendliness: 98 },
      style: { primary: 'emotional_story', secondary: ['late_night_radio', 'heart_to_heart'] },
      emotion: { warmth: 98, emotional_depth: 100, empathy: 99, happiness: 55, excitement: 30, confidence: 80 },
      acoustic: { pitch: 52, depth: 62, warmth: 98, resonance: 73, breathiness: 27, clarity: 93, articulation: 91, speed: 47, rhythm: 54, intonation: 89, energy: 42, emphasis: 79, pause: 94 }
    },
    dspProfile: { lowGain: 3.2, midFreq: 950, midGain: 2.8, presenceFreq: 3200, presenceGain: 3.8, highGain: 2.0, reverb: 0.12, reverbDecay: 0.50, compressor: { threshold: -15, ratio: 2.8, attack: 0.016, release: 0.30 } }
  },
  {
    id: 'vn_f_comedy_40',
    name: '[NEW] 40. Nữ Hài Hước Viral 👑 (VN-F-COMEDY)',
    provider: 'system',
    tier: 'pro',
    badge: '🔥 [NEW] Hot Trend VIP',
    gender: 'Female',
    ...
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dna: {
      region: { country: 'VN', region: 'SOUTH', accent: 'Southern Comedy', accent_strength: 65 },
      persona: { age: '20-35', personality: 'hài hước, duyên dáng', authority: 75, friendliness: 100 },
      style: { primary: 'comedy_viral', secondary: ['standup_comedy', 'entertainment_live'] },
      emotion: { warmth: 91, happiness: 98, humor: 100, confidence: 88, excitement: 98, energy: 98 },
      acoustic: { pitch: 78, depth: 25, warmth: 91, resonance: 42, breathiness: 15, clarity: 90, articulation: 88, speed: 89, rhythm: 98, intonation: 100, energy: 98, emphasis: 96, pause: 30 }
    },
    dspProfile: { lowGain: -1.0, midFreq: 1450, midGain: 3.2, presenceFreq: 4500, presenceGain: 5.8, highGain: 4.4, reverb: 0.05, reverbDecay: 0.28, compressor: { threshold: -21, ratio: 4.2, attack: 0.004, release: 0.14 } }
  }
];
