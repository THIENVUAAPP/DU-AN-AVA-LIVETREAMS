...
export const VIETNAMESE_FEMALE_VOICES = [
  // ---------------------------------------------------------------------------------------------------------
  // 🌸 PHÂN KHÚC 1: ĐỘ TUỔI 20 - 28 TUỔI (TRẺ TRUNG • GEN Z • KOC VIRAL • NHÍ NHẢNH • LIVESTREAM SÔI ĐỘNG)
  // ---------------------------------------------------------------------------------------------------------
  {
    id: 'free_vi_female',
    ...
    category: 'Quốc Dân Trẻ Trung (20-28t)',
    pitch: 1.04,
    rate: 1.02,
    recommendedFor: 'idol',
    desc: 'Giọng nữ trẻ trung trong trẻo quốc dân, phát âm mượt mà, cảm xúc tươi tắn tự nhiên.',
    ...
    dspProfile: { lowGain: 0.2, midFreq: 1200, midGain: 2.2, presenceFreq: 3600, presenceGain: 4.0, highGain: 2.8, reverb: 0.05, reverbDecay: 0.32, compressor: { threshold: -18, ratio: 3.5, attack: 0.008, release: 0.2 } }
  },
  {
    id: 'vn_nu_idol_live',
    name: 'Ngọc Nhi 👑 (Nữ 20-28t - Idol Livestream Trendy Sài Gòn [Miền Nam])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    rate: 1.04,
    recommendedFor: 'idol',
    desc: 'Giọng nữ Idol livestream Sài Gòn ngọt ngào, bắt trend, cuốn hút người xem từng giây.',
    ...
    edgeRate: '+4%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { lowGain: -0.5, midFreq: 1400, midGain: 2.8, presenceFreq: 4100, presenceGain: 5.2, highGain: 3.8, reverb: 0.06, reverbDecay: 0.35, compressor: { threshold: -20, ratio: 4.0, attack: 0.005, release: 0.16 } }
  },
  {
    id: 'vn_nu_koc_review',
    name: 'Khánh Linh 👑 (Nữ 20-28t - KOC Review Triệu View [Miền Nam])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    ageGroup: 'young',
    styleCategory: 'idol_genz',
    category: 'KOC Năng Động (20-28t) • Miền Nam',
    pitch: 1.05,
    rate: 1.05,
    recommendedFor: 'both',
    desc: 'Giọng nữ KOC Sài Gòn nói chuyện cực kỳ có duyên, review sắc bén, viral triệu view.',
    sampleText: 'Món này cưng xỉu luôn mấy bà ơi! Trải nghiệm 10 điểm không có nhưng nha, bấm vô giỏ hàng săn liền kẻo hết deal hời nè!',
    edgePitch: '+5%',
    edgeRate: '+5%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { lowGain: 0.0, midFreq: 1350, midGain: 2.6, presenceFreq: 3900, presenceGain: 4.8, highGain: 3.4, reverb: 0.04, reverbDecay: 0.28, compressor: { threshold: -19, ratio: 3.8, attack: 0.006, release: 0.18 } }
  },
  {
    id: 'vn_nu_ngotngao',
    name: 'Bảo Ngọc 👑 (Nữ 20-28t - Kẹo Ngọt Nũng Nịu Sài Gòn [Miền Nam])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    ageGroup: 'young',
    styleCategory: 'idol_genz',
    category: 'Kẹo Ngọt (20-28t) • Miền Nam',
    pitch: 1.08,
    rate: 1.03,
    recommendedFor: 'idol',
    desc: 'Giọng nữ trẻ trung ngọt lịm như kẹo bông gòn, dịu dàng, nũng nịu đốn tim người nghe.',
    ...
    edgeRate: '+3%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { lowGain: -1.0, midFreq: 1500, midGain: 3.0, presenceFreq: 4200, presenceGain: 5.5, highGain: 4.0, reverb: 0.07, reverbDecay: 0.38, compressor: { threshold: -19, ratio: 3.6, attack: 0.005, release: 0.16 } }
  },
  {
    id: 'vn_nu_vtuber_nhinhanh',
    name: 'Nhật Hạ 👑 (Nữ 20-28t - Anime / VTuber Nhí Nhảnh Gen Z [Sài Gòn])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    rate: 1.08,
    recommendedFor: 'idol',
    desc: 'Giọng nữ phong cách Anime / VTuber nhí nhảnh, cao vút líu lo, cực kỳ dễ thương và bắt trend giới trẻ.',
    sampleText: 'Cảm ơn các bạn đã ghé xem buổi live siêu cute của em nha! Nhớ bấm theo dõi kênh để nhận quà độc quyền nhé!',
    edgePitch: '+20%',
    edgeRate: '+6%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { semitones: 3.2, rate: 1.08, lowGain: -3.0, midFreq: 1800, midGain: 3.5, presenceFreq: 4500, presenceGain: 6.5, highGain: 5.2, compressor: { threshold: -22, ratio: 4.0, attack: 0.004, release: 0.14 } }
  },
  {
    id: 'vn_nu_mctruyenhinh',
    name: 'Thanh Trúc 👑 (Nữ 20-28t - MC Sự Kiện Trẻ Thanh Lịch [Hà Nội])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    ageGroup: 'young',
    styleCategory: 'mc_btv',
    category: 'MC Sự Kiện (20-28t) • Miền Bắc',
    pitch: 1.03,
    rate: 1.02,
    recommendedFor: 'both',
    desc: 'Giọng nữ dẫn chương trình trẻ trung, thanh lịch, phát âm tròn vành rõ chữ chuẩn Hà Nội.',
    sampleText: 'Chào mừng toàn thể quý vị khán giả đang theo dõi phiên phát sóng trực tiếp đặc biệt với hàng ngàn ưu đãi hấp dẫn hôm nay!',
    edgePitch: '+3%',
    edgeRate: '+2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { lowGain: 0.8, midFreq: 1250, midGain: 2.5, presenceFreq: 3700, presenceGain: 4.2, highGain: 2.8, reverb: 0.05, reverbDecay: 0.35, compressor: { threshold: -18, ratio: 3.5, attack: 0.008, release: 0.20 } }
  },
  {
    id: 'vn_nu_banhang',
    name: 'Ngọc Huyền 👑 (Nữ 20-28t - Chốt Đơn Siêu Tốc TikTok Shop [Hà Nội])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    category: 'Bán Hàng Sắc Bén (20-28t) • Miền Bắc',
    pitch: 1.06,
    rate: 1.06,
    recommendedFor: 'manager',
    desc: 'Giọng nữ chốt đơn livestream TikTok Shop tốc độ, dứt khoát, thúc đẩy khách hàng bấm mua ngay lập tức.',
    sampleText: 'Duy nhất trong phiên live hôm nay, sản phẩm đang có voucher trợ giá 50k trong giỏ hàng, các bác chốt đơn ngay kẻo hết nhé!',
    edgePitch: '+6%',
    edgeRate: '+6%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { lowGain: 0.4, midFreq: 1350, midGain: 2.7, presenceFreq: 3900, presenceGain: 5.0, highGain: 3.2, reverb: 0.03, reverbDecay: 0.24, compressor: { threshold: -21, ratio: 4.5, attack: 0.004, release: 0.15 } }
  },
  {
    id: 'vn_nu_giucdon_tocbien',
    name: 'Cẩm Tú 👑 (Nữ 20-28t - Giục Đơn Tốc Biến Flash Sale [Sài Gòn])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    ageGroup: 'young',
    styleCategory: 'banhang',
    category: 'Giục Đơn Sôi Sục (20-28t) • Miền Nam',
    pitch: 1.07,
    rate: 1.08,
    recommendedFor: 'manager',
    desc: 'Giọng nữ giục đơn dồn dập, tạo hiệu ứng đám đông mua sắm cuồng nhiệt trên sóng trực tiếp.',
    sampleText: 'Chỉ còn đúng 5 suất quà tặng độc quyền trong hôm nay thôi, cả nhà mình bấm mua ngay góc trái màn hình kẻo lỡ nha!',
    edgePitch: '+7%',
    edgeRate: '+8%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { lowGain: -0.5, midFreq: 1450, midGain: 3.0, presenceFreq: 4000, presenceGain: 5.2, highGain: 3.5, reverb: 0.03, reverbDecay: 0.22, compressor: { threshold: -22, ratio: 4.8, attack: 0.003, release: 0.12 } }
  },
  {
    id: 'vn_nu_danang_duyendang',
    name: 'Thanh Vân 👑 (Nữ 20-28t - Đà Nẵng Duyên Dáng, Mến Khách [Miền Trung])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    ageGroup: 'young',
    styleCategory: 'idol_genz',
    category: 'Giọng Đà Nẵng (20-28t) • Miền Trung',
    pitch: 1.04,
    rate: 1.02,
    recommendedFor: 'both',
    desc: 'Giọng nữ Đà Nẵng trong sáng, tươi tắn, hiếu khách, chất giọng duyên dáng đặc trưng miền Trung.',
    sampleText: 'Dạ em chào mọi người nghe! Hôm nay shop em có chương trình ưu đãi cực khủng cho khách đặt hàng sớm nhất nè nì!',
    edgePitch: '+4%',
    edgeRate: '+2%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { lowGain: 0.8, midFreq: 1250, midGain: 2.5, presenceFreq: 3650, presenceGain: 4.2, highGain: 3.0, reverb: 0.05, reverbDecay: 0.34, compressor: { threshold: -18, ratio: 3.5, attack: 0.009, release: 0.20 } }
  },
  {
    id: 'vn_nu_mientay_giongia',
    name: 'Út Mai 👑 (Nữ 20-28t - Miền Tây Giòn Giã, Dễ Mến [Miền Tây])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    category: 'Giọng Sông Nước (20-28t) • Miền Tây',
    pitch: 1.06,
    rate: 1.04,
    recommendedFor: 'both',
    desc: 'Giọng nữ miền Tây sông nước ngọt ngào, chất phác, vui tươi, nghe là thấy thương mến liền tay.',
    ...
    edgeRate: '+4%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { lowGain: 0.5, midFreq: 1300, midGain: 2.7, presenceFreq: 3800, presenceGain: 4.6, highGain: 3.2, reverb: 0.05, reverbDecay: 0.32, compressor: { threshold: -18, ratio: 3.6, attack: 0.008, release: 0.20 } }
  },
  {
    id: 'vn_nu_video_viral',
    name: 'Thu Trang 👑 (Nữ 20-28t - Video Viral & TikTok Reviewer [Sài Gòn])',
    provider: 'system',
    tier: 'pro',
    badge: '👑 Studio VIP',
    gender: 'Female',
    ...
    ageGroup: 'young',
    styleCategory: 'idol_genz',
    category: 'Viral Review (20-28t) • Miền Nam',
    pitch: 1.05,
    rate: 1.04,
    recommendedFor: 'both',
    desc: 'Giọng nữ review sản phẩm cuốn hút, phong cách năng động cho video ngắn và livestream triệu view.',
    sampleText: 'Review chân thật cho cả nhà đây! Sản phẩm hôm nay cực kỳ xịn sò, mọi người cùng xem ngay trong giỏ hàng nhé!',
    edgePitch: '+5%',
    edgeRate: '+4%',
    neuralVoice: 'vi-VN-HoaiMyNeural',
    dspProfile: { lowGain: 0.2, midFreq: 1320, midGain: 2.6, presenceFreq: 3750, presenceGain: 4.5, highGain: 3.0, reverb: 0.04, reverbDecay: 0.30, compressor: { threshold: -19, ratio: 3.8, attack: 0.007, release: 0.18 } }
  },
