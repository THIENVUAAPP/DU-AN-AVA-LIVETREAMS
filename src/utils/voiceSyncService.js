 ...
 * 
 * HỆ THỐNG 40+ GIỌNG ĐỌC VIỆT NAM CAO CẤP (20 NAM & 20 NỮ) + 28 GIỌNG QUỐC TẾ:
 * - 100% Giọng có mẫu thu âm Studio chính hãng riêng biệt, nghe thử tức thì (0ms latency).
 * - Đúng chuẩn Nam / Nữ, ngữ điệu, phong cách chuyên nghiệp, cảm xúc chân thực đỉnh cao.
 */

import { globalLipSyncEngine } from '../lib/avatar-sync/AvatarLipSyncEngine';

export const ELEVENLABS_VOICES = [
  // ==================== 1. 20 GIỌNG NỮ VIỆT NAM CAO CẤP (PRO STUDIO) ====================
  { 
  ...
  // ==================== 2. 20 GIỌNG NAM VIỆT NAM CAO CẤP (PRO STUDIO) ====================
  { 
    id: 'el_adam', 
